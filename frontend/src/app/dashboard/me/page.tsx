      ...
      <main className="min-h-screen bg-[#F6F1E7] pt-14 pb-8">
        ...
        <div className="w-full max-w-2xl lg:max-w-3xl mx-auto px-4 lg:px-8 pt-8 space-y-6">
          ...
          <div className="rounded-2xl border border-[#DDD8CE] bg-[#EDE8DC] p-6 flex flex-col items-center gap-4 text-center">
            ...
            <Link href="/login" className="w-full flex items-center justify-center gap-3 rounded-xl border border-[#DDD8CE] bg-white hover:bg-[#EDE8DC] text-gray-700 text-sm font-medium px-4 py-3 transition-all shadow-sm">
