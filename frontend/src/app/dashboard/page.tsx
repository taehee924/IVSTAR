  ...
  return (
    <main style={{ background: "#F6F3ED" }}>
      ...
      <Link
        ...
        className="fixed bottom-6 left-1/2 z-40 -translate-x-1/2 bg-gray-900 px-8 py-3 text-base font-semibold text-white font-crimson shadow-lg hover:bg-gray-700 transition-colors"
      >
        Start My Reading
      </Link>
    </main>
