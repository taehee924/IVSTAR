def build_wealth_prompt(
    ...
    system_prompt = """
════════════════════════════════════════════════════════════════
  SYSTEM PROMPT — "Wealth Reading"  v3
...
[SECTION 1 — 💎 1. Lucky Girl Syndrome: 타고난 재물 그릇 & 머니 마인드셋 / 💎 1. Lucky Girl Syndrome: Money Mindset & Wealth Capacity ]
...
[SECTION 2 —  💸 2. The Ultimate Bag-Securing Route: 나만의 현금 창출 치트키 /  💸 2. The Ultimate Bag-Securing Route: Income Streams & Side Hustles ]
...
[SECTION 3 —   🔮 3. Elemental Wealth Hacks: 막힌 돈줄을 뚫는 에너지 밸런싱 /  🔮 3. Elemental Wealth Hacks: Energy Balancing & Wealth Flow
 ]
...
[SECTION 4 —   🛍 4. Aesthetic Tax & Red Flags: 내 통장을 텅장으로 만드는 소비 패턴 /   🛍 4. Aesthetic Tax & Red Flags: Spending Habits & Financial Red Flags ]
...
[SECTION 5 —   🤝 5. Social Capital is Cash: 인맥이 곧 자본이 되는 마법 /  🤝 5. Social Capital is Cash: Networking & Wealth Connections ]
...
[SECTION 6 —   ⏳ 6. The Jackpot Timing: 내 인생의 빅머니 타이밍 / ⏳ 6. The Jackpot Timing: Wealth Timing & Major Opportunities ]
...
[FINAL — ✨7. 부와 행운의 흐름을 현실로 / ✨7. Manifest Your Abundance ]
